...
public class ConstructorUtilsTest {
    ...
    public static class nullClass{
        public nullClass(Integer i) {}

        static class inner {
            public inner(Number i) {}
        }

        public static Class getSynth() {return inner.class;};
    }
    ...
    @Test
    @DisplayName("Default constructor should still work for JavaBean support")
    public void testDefaultConstructor() {
        ConstructorUtils defConstructor = new ConstructorUtils();
        assertInstanceOf(ConstructorUtils.class, defConstructor);
    }

    @Test
    @DisplayName("Throws error when given a class that has no constructor")
    public void testNoConstructor() {
        assertThrows(NoSuchMethodException.class, () -> {
           ConstructorUtils.invokeConstructor(badClass.class, null, null);
        });
    }

    /*
    Improves branch coverage for missing branches in getMatchingAccessibleConstructor.
    Uses a static inner class with a parent class type of Integer to force entry into the missing branch.
    */

    @Test
    public void testAccessibleConstructor() {
        assertNull(ConstructorUtils.getMatchingAccessibleConstructor(nullClass.getSynth(), singletonArray(Integer.class)));
    }
